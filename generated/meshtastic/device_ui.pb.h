...
typedef struct _meshtastic_NodeFilter {
    ...
    int8_t channel;
/* @@protoc_insertion_point(struct:meshtastic_NodeFilter) */
...
typedef struct _meshtastic_NodeHighlight {
    ...
    char node_name[16];
/* @@protoc_insertion_point(struct:meshtastic_NodeHighlight) */
...
typedef struct _meshtastic_GeoPoint {
    ...
    int32_t longitude;
/* @@protoc_insertion_point(struct:meshtastic_GeoPoint) */
} meshtastic_GeoPoint;
...
typedef struct _meshtastic_Map {
    ...
    bool follow_gps;
/* @@protoc_insertion_point(struct:meshtastic_Map) */
} meshtastic_Map;
...
/* @@protoc_insertion_point(struct:meshtastic_DeviceUIConfig) */
