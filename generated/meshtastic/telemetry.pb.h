...
/* @@protoc_insertion_point(struct:meshtastic_DeviceMetrics) */
...
/* @@protoc_insertion_point(struct:meshtastic_EnvironmentMetrics) */
...
typedef struct _meshtastic_PowerMetrics {
    ...
    float ch8_current;
/* @@protoc_insertion_point(struct:meshtastic_PowerMetrics) */
...
typedef struct _meshtastic_AirQualityMetrics {
    ...
    float particles_tps;
/* @@protoc_insertion_point(struct:meshtastic_AirQualityMetrics) */
...
typedef struct _meshtastic_LocalStats {
 ...
 This will always be zero for ROUTERs/REPEATERs. If this number is high, some other node(s) is/are relaying faster than you. */
    ...
    int32_t noise_floor;
/* @@protoc_insertion_point(struct:meshtastic_LocalStats) */
...
/* @@protoc_insertion_point(struct:meshtastic_TrafficManagementStats) */
...
typedef struct _meshtastic_HealthMetrics {
    ...
    bool has_temperature;
    float temperature;
/* @@protoc_insertion_point(struct:meshtastic_HealthMetrics) */
...
/* @@protoc_insertion_point(struct:meshtastic_HostMetrics) */
...
/* @@protoc_insertion_point(struct:meshtastic_Telemetry) */
...
/* @@protoc_insertion_point(struct:meshtastic_Nau7802Config) */
...
/* @@protoc_insertion_point(struct:meshtastic_SEN5XState) */
