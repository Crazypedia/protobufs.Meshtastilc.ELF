...
/* @@protoc_insertion_point(struct:meshtastic_NetworkConnectionStatus) */
...
typedef struct _meshtastic_WifiConnectionStatus {
    ...
    int32_t rssi;
/* @@protoc_insertion_point(struct:meshtastic_WifiConnectionStatus) */
...
typedef struct _meshtastic_EthernetConnectionStatus {
    ...
    bool has_status;
    meshtastic_NetworkConnectionStatus status;
/* @@protoc_insertion_point(struct:meshtastic_EthernetConnectionStatus) */
...
typedef struct _meshtastic_BluetoothConnectionStatus {
    ...
    /* Whether the device has an active connection or not */
    bool is_connected;
/* @@protoc_insertion_point(struct:meshtastic_BluetoothConnectionStatus) */
...
typedef struct _meshtastic_SerialConnectionStatus {
    ...
    /* Whether the device has an active connection or not */
    bool is_connected;
/* @@protoc_insertion_point(struct:meshtastic_SerialConnectionStatus) */
...
/* @@protoc_insertion_point(struct:meshtastic_DeviceConnectionStatus) */
