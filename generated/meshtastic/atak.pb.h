...
/* @@protoc_insertion_point(struct:meshtastic_GeoChat) */
} meshtastic_GeoChat;
...
/* @@protoc_insertion_point(struct:meshtastic_Group) */
} meshtastic_Group;
...
typedef struct _meshtastic_Status {
    /* Battery level */
    uint8_t battery;
/* @@protoc_insertion_point(struct:meshtastic_Status) */
} meshtastic_Status;
...
/* @@protoc_insertion_point(struct:meshtastic_Contact) */
} meshtastic_Contact;
...
typedef struct _meshtastic_PLI {
 ...
 in floating point */
    ...
    /* Course in degrees */
    uint16_t course;
/* @@protoc_insertion_point(struct:meshtastic_PLI) */
} meshtastic_PLI;
...
/* @@protoc_insertion_point(struct:meshtastic_TAKPacket) */
...
typedef struct _meshtastic_AircraftTrack {
    ...
    char cot_host_id[64];
/* @@protoc_insertion_point(struct:meshtastic_AircraftTrack) */
...
typedef struct _meshtastic_CotGeoPoint {
 ...
 Add to the enclosing event's latitude_i to recover the absolute latitude. */
    ...
    int32_t lon_delta_i;
/* @@protoc_insertion_point(struct:meshtastic_CotGeoPoint) */
...
/* @@protoc_insertion_point(struct:meshtastic_DrawnShape) */
...
typedef struct _meshtastic_Marker {
 ...
 surface, and the dict compresses the repetition effectively. */
    char iconset[80];
/* @@protoc_insertion_point(struct:meshtastic_Marker) */
} meshtastic_Marker;
...
typedef struct _meshtastic_RangeAndBearing {
    ...
    uint16_t stroke_weight_x10;
/* @@protoc_insertion_point(struct:meshtastic_RangeAndBearing) */
...
typedef struct _meshtastic_Route_Link {
    ...
    uint8_t link_type;
/* @@protoc_insertion_point(struct:meshtastic_Route_Link) */
...
typedef struct _meshtastic_Route {
    ...
    bool truncated;
/* @@protoc_insertion_point(struct:meshtastic_Route) */
} meshtastic_Route;
...
typedef struct _meshtastic_CasevacReport {
 ...
 the 237 B LoRa MTU. */
    pb_callback_t zmist;
/* @@protoc_insertion_point(struct:meshtastic_CasevacReport) */
...
typedef struct _meshtastic_ZMistEntry {
 ...
 "Gunshot" or a serial). */
    ...
    pb_callback_t t;
/* @@protoc_insertion_point(struct:meshtastic_ZMistEntry) */
...
/* @@protoc_insertion_point(struct:meshtastic_EmergencyAlert) */
...
typedef struct _meshtastic_TaskRequest {
 ...
 tight in options to keep the worst-case under the LoRa MTU. */
    char note[48];
/* @@protoc_insertion_point(struct:meshtastic_TaskRequest) */
...
/* @@protoc_insertion_point(struct:meshtastic_TAKEnvironment) */
...
typedef struct _meshtastic_SensorFov {
 ...
 Optional — empty string means "unknown model" (ATAK-CIV default). */
    pb_callback_t model;
/* @@protoc_insertion_point(struct:meshtastic_SensorFov) */
...
typedef struct _meshtastic_TakTalkMessage {
 ...
 icon. Proto3 only encodes when true so empty payload cost is 0 bytes. */
    bool from_voice;
/* @@protoc_insertion_point(struct:meshtastic_TakTalkMessage) */
...
/* @@protoc_insertion_point(struct:meshtastic_TakTalkRoomData) */
...
/* @@protoc_insertion_point(struct:meshtastic_Marti) */
} meshtastic_Marti;
...
/* @@protoc_insertion_point(struct:meshtastic_TAKPacketV2) */
