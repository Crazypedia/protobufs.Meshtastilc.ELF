...
typedef struct _meshtastic_AdminMessage_InputEvent {
    ...
    uint16_t touch_y;
/* @@protoc_insertion_point(struct:meshtastic_AdminMessage_InputEvent) */
...
/* @@protoc_insertion_point(struct:meshtastic_AdminMessage_OTAEvent) */
...
typedef struct _meshtastic_LockdownAuth {
 ...
 valid_until_epoch, max_session_seconds, and lock_now are ignored. */
    bool disable;
/* @@protoc_insertion_point(struct:meshtastic_LockdownAuth) */
...
typedef struct _meshtastic_HamParameters {
 ...
 Appended to callsign */
    char long_name[15];
/* @@protoc_insertion_point(struct:meshtastic_HamParameters) */
...
/* @@protoc_insertion_point(struct:meshtastic_NodeRemoteHardwarePinsResponse) */
...
/* @@protoc_insertion_point(struct:meshtastic_SharedContact) */
...
/* @@protoc_insertion_point(struct:meshtastic_KeyVerificationAdmin) */
...
typedef struct _meshtastic_SCD4X_config {
    ...
    bool set_power_mode;
/* @@protoc_insertion_point(struct:meshtastic_SCD4X_config) */
...
/* @@protoc_insertion_point(struct:meshtastic_SEN5X_config) */
...
typedef struct _meshtastic_SCD30_config {
    ...
    bool has_soft_reset;
    bool soft_reset;
/* @@protoc_insertion_point(struct:meshtastic_SCD30_config) */
...
/* @@protoc_insertion_point(struct:meshtastic_SHTXX_config) */
...
/* @@protoc_insertion_point(struct:meshtastic_SensorConfig) */
...
/* @@protoc_insertion_point(struct:meshtastic_AdminMessage) */
