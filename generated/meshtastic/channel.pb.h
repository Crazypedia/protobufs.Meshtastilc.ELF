...
typedef struct _meshtastic_ModuleSettings {
 ...
 Useful for noisy public channels you don't necessarily want to disable */
    bool is_muted;
/* @@protoc_insertion_point(struct:meshtastic_ModuleSettings) */
...
/* @@protoc_insertion_point(struct:meshtastic_ChannelSettings) */
...
/* @@protoc_insertion_point(struct:meshtastic_Channel) */
} meshtastic_Channel;
