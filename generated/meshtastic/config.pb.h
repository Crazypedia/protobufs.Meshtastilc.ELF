...
/* @@protoc_insertion_point(struct:meshtastic_Config_DeviceConfig) */
...
/* @@protoc_insertion_point(struct:meshtastic_Config_PositionConfig) */
...
/* @@protoc_insertion_point(struct:meshtastic_Config_PowerConfig) */
...
typedef struct _meshtastic_Config_NetworkConfig_IpV4Config {
    ...
    uint32_t dns;
/* @@protoc_insertion_point(struct:meshtastic_Config_NetworkConfig_IpV4Config) */
...
typedef struct _meshtastic_Config_NetworkConfig {
 ...
 acquire an address via DHCP */
    ...
    bool ipv6_enabled;
/* @@protoc_insertion_point(struct:meshtastic_Config_NetworkConfig) */
...
/* @@protoc_insertion_point(struct:meshtastic_Config_DisplayConfig) */
...
/* @@protoc_insertion_point(struct:meshtastic_Config_LoRaConfig) */
...
typedef struct _meshtastic_Config_BluetoothConfig {
    ...
    uint32_t fixed_pin;
/* @@protoc_insertion_point(struct:meshtastic_Config_BluetoothConfig) */
...
/* @@protoc_insertion_point(struct:meshtastic_Config_SecurityConfig) */
} meshtastic_Config_SecurityConfig;

/* Blank config request, strictly for getting the session key */
typedef struct _meshtastic_Config_SessionkeyConfig {
    char dummy_field;
/* @@protoc_insertion_point(struct:meshtastic_Config_SessionkeyConfig) */
...
/* @@protoc_insertion_point(struct:meshtastic_Config) */
} meshtastic_Config;
