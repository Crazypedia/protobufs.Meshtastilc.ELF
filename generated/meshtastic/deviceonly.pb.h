...
/* @@protoc_insertion_point(struct:meshtastic_PositionLite) */
...
/* @@protoc_insertion_point(struct:meshtastic_UserLite) */
} meshtastic_UserLite;
...
typedef struct _meshtastic_NodeInfoLite {
 ...
 float snr is always zeroed on disk; this field carries all persisted SNR. */
    int32_t snr_q4;
/* @@protoc_insertion_point(struct:meshtastic_NodeInfoLite) */
...
/* @@protoc_insertion_point(struct:meshtastic_DeviceState) */
...
/* @@protoc_insertion_point(struct:meshtastic_NodePositionEntry) */
...
/* @@protoc_insertion_point(struct:meshtastic_NodeTelemetryEntry) */
...
/* @@protoc_insertion_point(struct:meshtastic_NodeEnvironmentEntry) */
...
/* @@protoc_insertion_point(struct:meshtastic_NodeStatusEntry) */
...
/* @@protoc_insertion_point(struct:meshtastic_NodeDatabase) */
...
typedef struct _meshtastic_ChannelFile {
 ...
 NodeDB.cpp in the device code. */
    uint32_t version;
/* @@protoc_insertion_point(struct:meshtastic_ChannelFile) */
...
typedef struct _meshtastic_BackupPreferences {
    ...
    bool has_owner;
    meshtastic_User owner;
/* @@protoc_insertion_point(struct:meshtastic_BackupPreferences) */
